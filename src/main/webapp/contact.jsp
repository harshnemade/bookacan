            ...
            <div class="details">
                ...
                <div class="contact-items-wrapper">
                    <div class="contact-items">
                        ...
                        <p><strong>Address:</strong>Dr. D. Y. Patil College. Akurdi Pune 35</p>
                    </div>
                    <div class="contact-items">
                        <span class="material-icons">local_phone</span>
                        <p><strong>Phone:</strong> +91 70303 99491</p>
                    </div>
                    <div class="contact-items">
                    ...
                    <div class="contact-items">
                        ...
                        <p><strong>Website:</strong><a href="#"> www.bookacan.com</a></p>
                    </div>
                </div>
